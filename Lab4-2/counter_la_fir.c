...
#define reg_fir_ap_ctrl (*(volatile uint32_t *)0x30000000)  //ap_ctrl
#define reg_fir_len (*(volatile uint32_t *)0x30000010) // 10 ~ 14 //fir_lenth
#define reg_fir_coeff (*(volatile uint32_t *)0x30000040)   // tap 40 ~ 7F // fir_coeff 
#define reg_fir_x (*(volatile uint32_t *)0x30000080)	   // 80 ~ 83 // fir_y_in
#define reg_fir_y (*(volatile uint32_t *)0x30000084)	   // 84 ~ 87 // fir_y_out
#define N 11		   // # of Tap
...
*/	
	...
	for (int i = 0; i < N; i++){
		(*(volatile uint32_t *)(0x30000040 + (4 * i))) = *(tap + i); //reg_coeff+4*i
	}
